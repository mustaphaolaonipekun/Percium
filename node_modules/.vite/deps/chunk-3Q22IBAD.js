...
var ICONS = {
  add: async () => (await import("./add-SRFZMILE.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-QYKBXNQM.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-3TNJNSIP.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-IIPGAREM.js")).appStoreSvg,
  apple: async () => (await import("./apple-A77FN2V2.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-B72I3I2W.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-ZZKAJOO2.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-H47WJXF2.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-HE776IMA.js")).arrowTopSvg,
  bank: async () => (await import("./bank-6JJB47DA.js")).bankSvg,
  browser: async () => (await import("./browser-EOO7SJYY.js")).browserSvg,
  card: async () => (await import("./card-Y23BPVSM.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-KMDU2GCT.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-W73RNRCB.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-6MJXEJOT.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-MEUMTT7Y.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-KV2UIWYW.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-G4FYNJ75.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-V7QV7WL3.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-B6FHSUYT.js")).clockSvg,
  close: async () => (await import("./close-PWR33U7U.js")).closeSvg,
  compass: async () => (await import("./compass-CUNP4UAF.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ISIRQ5QD.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-Z2MGAPTK.js")).copySvg,
  cursor: async () => (await import("./cursor-NEZEIQ5F.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-LZ3TDJOC.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-WVWIPNAE.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-OBPLYSGF.js")).disconnectSvg,
  discord: async () => (await import("./discord-SP43GT45.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-KC73FMDR.js")).etherscanSvg,
  extension: async () => (await import("./extension-3FAMQK6F.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CZZERJ7J.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-ZJ2EZ2D7.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-5QIJJBZZ.js")).farcasterSvg,
  filters: async () => (await import("./filters-WR5R4VJB.js")).filtersSvg,
  github: async () => (await import("./github-DMB25ADN.js")).githubSvg,
  google: async () => (await import("./google-3MYDQ3H4.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-A2JMEDS2.js")).helpCircleSvg,
  image: async () => (await import("./image-LBIZHH5Z.js")).imageSvg,
  id: async () => (await import("./id-6B76S2GK.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-J4Y52CGK.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-7MMDJPEC.js")).lightbulbSvg,
  mail: async () => (await import("./mail-7MKUNKV2.js")).mailSvg,
  mobile: async () => (await import("./mobile-NRYSDHM4.js")).mobileSvg,
  more: async () => (await import("./more-Y4LM55KD.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-VVU3ZVOY.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-JWVFCWDV.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-QFDTRR7P.js")).offSvg,
  playStore: async () => (await import("./play-store-PVYAIWUZ.js")).playStoreSvg,
  plus: async () => (await import("./plus-NZV3EV2F.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-ZLLNFQJJ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-AUIWUFVR.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-ASOPQ2Z5.js")).refreshSvg,
  search: async () => (await import("./search-FFY2HHAX.js")).searchSvg,
  send: async () => (await import("./send-6IBUP4HL.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-YTHJ5ORI.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-VWJKW7IB.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-I4UHYW7V.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-LWP7Q7KJ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-6H43CVBE.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-HK2FJ4E5.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-O2UZCZO6.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-RCBCZ3LT.js")).twitchSvg,
  twitter: async () => (await import("./x-HYTJTSRF.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-YI2M7X55.js")).twitterIconSvg,
  verify: async () => (await import("./verify-ETE2MC5F.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-B26USPJC.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-FF5T3TQZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-JCMRMRVD.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-JCMRMRVD.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-JCMRMRVD.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-FGLILXFM.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-ZMW4D33J.js")).warningCircleSvg,
  x: async () => (await import("./x-HYTJTSRF.js")).xSvg,
  info: async () => (await import("./info-HWNZNZ5G.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-LCEZA4U6.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-THWQS7Y5.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3Q22IBAD.js.map
